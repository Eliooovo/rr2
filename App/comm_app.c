    ...
    uint8_t packet[COMM_APP_PACKET_SIZE])
{
    ...
    if (g_comm_app_feedback.kfs_tip_rotate_valid != 0U) {
        fields[7] = g_comm_app_feedback.kfs_tip_rotate_rad;
    }
    if (g_comm_app_feedback.kfs_grip_valid != 0U) {
        fields[8] = g_comm_app_feedback.kfs_grip_position_m;
    }
    if (g_comm_app_feedback.weapon_rotate_valid != 0U) {
        fields[9] = g_comm_app_feedback.weapon_rotate_rad;
    }
    if (g_comm_app_feedback.weapon_grip_valid != 0U) {
        fields[10] = g_comm_app_feedback.weapon_grip_position_m;
    }
