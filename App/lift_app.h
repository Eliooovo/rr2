...
/*
 * 电机顺序固定为 LF、RF、RB、LB，实车映射为
 * LF=1、LB=2、RB=3、RF=4。direction 为 1 表示不反向，为 -1 表示反向。
 */
#define LIFT_APP_MOTOR_CONFIG_INIT                                     \
    {                                                                  \
        {1U, -1, 6.5f, 0.0f, 0.0f, 6.0f, 0.5f, 0.0f, 1800.0f, 5000.0f}, /* LF 左前 */ \
        {4U,  1, 6.5f, 0.0f, 0.0f, 6.0f, 0.5f, 0.0f, 1800.0f, 5000.0f}, /* RF 右前 */ \
        {3U, -1, 6.5f, 0.0f, 0.0f, 6.0f, 0.5f, 0.0f, 1800.0f, 5000.0f}, /* RB 右后 */ \
        {2U,  1, 6.5f, 0.0f, 0.0f, 6.0f, 0.5f, 0.0f, 1800.0f, 5000.0f}, /* LB 左后 */ \
    }
