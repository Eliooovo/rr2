...
#define LIFT_APP_MOTOR_CONFIG_INIT                                     \
    {                                                                  \
        {1U, -1, 6.5f, 0.0f, 0.0f, 6.0f, 0.5f, 0.0f, 700.0f, 5000.0f}, \
        {2U, 1, 6.5f, 0.0f, 0.0f, 6.0f, 0.5f, 0.0f, 700.0f, 5000.0f}, \
        {3U, -1, 6.5f, 0.0f, 0.0f, 6.0f, 0.5f, 0.0f, 700.0f, 5000.0f}, \
        {4U, 1, 6.5f, 0.0f, 0.0f, 6.0f, 0.5f, 0.0f, 700.0f, 5000.0f}, \
    }
